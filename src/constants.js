...
export const dialogueData = {
    ...
    library: `Peruse my virtual bookshelf, stocked with an array of web development resources. Among them, you'll find gems in various languages, including French (oui, je parle français!). While I may not have finished every book, each one contributes to my ever-growing knowledge base in web development.`,
